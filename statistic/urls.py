...
from statistic.views import WordFrequencyViewSet, WordListViewSet, TimeLinePodcastsViewSet, PodcastListViewSet, TimeLineEpisodesViewSet, PodcastCosineSimilarityViewSet, SignificantPodcastWordsViewSet
